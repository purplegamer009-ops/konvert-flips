...
module.exports = {
  data: new SlashCommandBuilder().setName('unlock').setDescription('🔓  Owner: re-enable games in this channel')
  ...
  async execute(interaction,client){
    ...
    await interaction.reply({embeds:[em('Konvault\' Channel Lock','🔓  Games re-enabled in <#'+target.id+'>')],ephemeral:true});
  },
};
