...
module.exports = {
  data: new SlashCommandBuilder().setName('setaddress').setDescription('🔧 Owner: set LTC wallet address')
  ...
  async execute(interaction){
    ...
    await interaction.reply({content:'✅ LTC address set: `'+address+'`',ephemeral:true});
  },
};
