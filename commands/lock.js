...
module.exports = {
  data: new SlashCommandBuilder().setName('lock').setDescription('🔒  Owner: disable games in this channel')
  ...
  async execute(interaction,client){
    ...
    await interaction.reply({embeds:[em('Konvault\' Channel Lock','🔒  Games disabled in <#'+target.id+'>\n\nUse `/unlock` to re-enable.')],ephemeral:true});
  },
};
